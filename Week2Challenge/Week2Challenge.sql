...
CREATE OR REPLACE PROCEDURE SP_GIVE_RAISE(DEPT_ID IN INTEGER, AVG_SAL OUT NUMBER, IS_ID_VALID OUT BOOLEAN)
IS
BEGIN

    -- SETTING THE IS_ID_VALID BOOLEAN VARIABLE
    FOR I IN (DEPARTMENT_ID) FROM EMPLOYEE
    ...
    -- UPDATING EMPLOYEE SALARY BASED ON DEPARTMENT
    UPDATE EMPLOYEE
    ...
    SELECT AVG(SALARY) INTO AVG_SAL FROM EMPLOYEE WHERE EMPLOYEE.DEPARTMENT_ID = DEPT_ID;
