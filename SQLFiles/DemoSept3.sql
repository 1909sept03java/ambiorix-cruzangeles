...
ALTER TABLE BEEHIVE ADD CONTRAINT CK_BEEHIVE_WEIGHT
CHECK (HONEY_AMT >= 0);
/
...
CREATE OR REPLACE PROCEDURE SP_FEED_BEAR(B_ID IN NUMBER, HONEY_AMT IN NUMBER, AMT_FED OUT NUMBER)
IS
-- VARIABLE DECLARATIONS
BB_EXISTS INTEGER
BEGIN
    -- CHECK THAT THE BEAR AND BEEHIVE ARE CORRECTLY MATCHED
    -- IS THE AMOUNT OF HONEY > 0 AND LESS THAN THE HIVE'S WEIGHT?
        -- REDUCE THE HIVE WEIGHT
